    ...
    <section id="pricing" className='flex justify-center items-center px-6 md:px-10 py-24 bg-white text-black'>
      <div className='py-16 md:py-24 max-w-7xl w-full'>
        <div className='mb-12 md:mb-16'>
          ...
          <p className='text-neutral-500 text-[14px] font-normal w-md px-4 md:px-0 mx-auto text-center leading-relaxed'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-0 py-12'>
          {steps.map((step, index) => (
            <div key={index} className='flex flex-col space-y-6 md:px-12 first:md:pl-0 last:md:pr-0 border-neutral-100 md:border-r last:border-none'>
              {/* Step Number */}
              <span className='text-[48px] font-bold text-neutral-100 select-none leading-none'>
                {step.number}
              </span>
