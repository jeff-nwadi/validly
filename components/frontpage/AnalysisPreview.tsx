  ...
  return (
    <section className='flex justify-center items-center px-6 md:px-10'>
      <div className='py-16 md:py-24 max-w-7xl w-full'>
        ...
        {/* Main Analysis Card */}
        <div className='relative bg-[#0A0A0A] border border-[#1F1F1F] rounded-2xl md:rounded-3xl p-6 md:p-14 overflow-hidden'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-5 gap-6'>
            ...
            <div className='lg:col-span-3 space-y-6'>
              ...
              {/* Top Competitors */}
              <div className='bg-[#111111]/50 border border-[#1F1F1F] rounded-xl md:rounded-2xl p-5 md:p-6'>
                ...
                <div className='space-y-4'>
                  <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-[#0A0A0A] border border-[#1F1F1F] rounded-xl gap-4'>
                    <div className='flex items-center gap-4'>
                      <div className='w-10 h-10 bg-[#3B82F6] rounded-lg flex items-center justify-center text-white font-bold'>B</div>
                      <span className='text-[#F8F8F8] font-medium'>BakeManage</span>
                    </div>
                    <span className='text-[#9A9A9A] text-[10px] md:text-[12px] uppercase tracking-wide px-3 py-1 bg-[#1A1A1A] rounded-md border border-[#2C2C2C]'>Direct Comp</span>
                  </div>
                  
                  <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-[#0A0A0A] border border-[#1F1F1F] rounded-xl gap-4'>
                    <div className='flex items-center gap-4'>
                      <div className='w-10 h-10 bg-[#EC4899] rounded-lg flex items-center justify-center text-white font-bold'>S</div>
                      <span className='text-[#F8F8F8] font-medium'>Square for Retail</span>
                    </div>
                    <span className='text-[#9A9A9A] text-[10px] md:text-[12px] uppercase tracking-wide px-3 py-1 bg-[#1A1A1A] rounded-md border border-[#2C2C2C]'>Indirect Comp</span>
                  </div>
                </div>
              </div>
            ...
            <div className='lg:col-span-2 space-y-4 md:space-y-6'>
              ...
              {/* Biggest Risks */}
              <div className='bg-[#191111] border border-[#521C1C]/50 rounded-xl md:rounded-2xl p-5 md:p-6'>
              ...
              {/* Market Size */}
              <div className='bg-[#111917] border border-[#10B981]/20 rounded-xl md:rounded-2xl p-5 md:p-6'>
                <div className='flex items-center gap-3 mb-4 md:mb-6'>
