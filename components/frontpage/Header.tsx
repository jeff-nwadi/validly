  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 py-4 md:px-10">
      <div className={cn(
        ...
        scrolled ? "bg-white/70 backdrop-blur-xl border-slate-200 py-3 px-6" : "bg-transparent py-4 px-0"

      )}>
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-9 h-9 bg-[#4F46E5] rounded-xl flex items-center justify-center transition-transform group-hover:scale-105">
          ...
          <div className='hidden lg:flex font-bold text-[13px] gap-8 items-center uppercase tracking-widest'>
            ...
            <Link href="/register" >
                <button className='bg-[#4F46E5] text-white px-6 py-2.5 rounded-xl transition-all active:scale-95'>
                    Get started
                </button>
            </Link>
          </div>
          ...
          <nav className="flex flex-col items-center justify-center gap-12 p-10 pt-20">
            ...
            <div className='flex flex-col items-center gap-6 w-full max-w-[320px] pt-10'>
              ...
              <Link href="/register" onClick={() => setIsOpen(false)} className="w-full">
                <button className='w-full bg-[#4F46E5] text-white py-5 rounded-2xl font-bold text-[18px]'>
                    Get started
                </button>
              </Link>
