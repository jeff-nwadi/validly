...
export default function AuthLayout({ children, title, subtitle }: { children: React.ReactNode, title: string, subtitle: string }) {
  return (
    <div className='min-h-screen bg-[#070707] flex font-sans'>
      ...
      <div className='hidden lg:flex lg:w-1/2 relative flex-col p-16 overflow-hidden border-r border-[#1F1F1F]'>
        {/* Background Image */}
        <div className='absolute inset-0 z-0'>
          <Image 
            ...
            priority
          />
          <div className='absolute inset-0 bg-linear-to-t from-[#070707] via-transparent to-[#070707]/80' />
        </div>
      ...
      <div className='w-full lg:w-1/2 flex flex-col p-8 md:p-16 lg:p-24 relative overflow-y-auto'>
        ...
        <Link 
          href="/" 
          className='flex items-center gap-2 text-[#9A9A9A] hover:text-[#F8F8F8] transition-colors mb-12 md:mb-16 sub-text text-[14px]'
        >
        ...
        {/* Footer Legal */}
        <p className='mt-auto pt-16 text-center text-[#9A9A9A] text-[13px] leading-relaxed max-w-[320px] mx-auto'>
          By clicking continue, you agree to our <Link href="#" className='text-[#F8F8F8] hover:underline font-medium'>Terms of Service</Link> and <Link href="#" className='text-[#F8F8F8] hover:underline font-medium'>Privacy Policy</Link>.
        </p>
      </div>
    </div>
  )
